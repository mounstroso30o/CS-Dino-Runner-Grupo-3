...
class Obstacle(Sprite):
    def __init__(self, image, obstacle_type):
        ...
        self.obstacle_show =self.image[self.obstacle_type]
        self.rect = self.obstacle_show.get_rect() #obtenemor un tipo y pocisiones sobre una recta 
    ...
    def draw(self, screen):
        screen.blit(self.obstacle_show, (self.rect.x, self.rect.y))